...
@section('content')
  ...
  @foreach($happyhours as $happyhour)
    ...
    {!! Form::model($happyhour, ['route' => ['admin.bars.happyhours.update', $happyhour->id], 'method' => 'PATCH' , 'class' => 'form-inline']) !!}
    <div class="container-fluid row align-items-center text-center my-2">
      ...
      {!! Form::close() !!}
      <div class="col">
       {!! Form::open(['method' => 'DELETE', 'route' => ['admin.bars.happyhours.destroy', $happyhour->id]]) !!}
  ...
  <div>
    <a class="btn btn-info text-white fixed-bottom" data-toggle="modal" data-target="#happyhoursModal">Nuevo Horario</a>
  </div>
  @include('admin.happyhours.create')
