...
@section('content')
  ...
  @foreach($happyhours as $happyhour)
    ...
    {!! Form::model($happyhour, ['route' => ['happyhours.update', $happyhour->id], 'method' => 'PATCH' , 'class' => 'form-inline']) !!}
    <div class="container-fluid row align-items-center text-center my-2">
      ...
      {!! Form::close() !!}
      <div class="col">
       {!! Form::open(['method' => 'DELETE', 'route' => ['happyhours.destroy', $happyhour->id]]) !!}
